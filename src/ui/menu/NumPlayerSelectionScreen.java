	...
	public void show() {
        ...
        for (int i = 0; i < modeNames.length; i++) {
            ...
            button.addActionListener(e -> {
                ...
                navigator.navigateTo(MenuNavigator.PLAYER_NAMES_SCREEN, this, gameConfig);
            });
        ...
        backButton.addActionListener(e -> navigator.navigateTo(MenuNavigator.GAME_SELECTION_SCREEN, this, gameConfig));
