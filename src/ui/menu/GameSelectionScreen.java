	...
	public void show() {
        ...
        for (int i = 0; i < modeNames.length; i++) {
            ...
            button.addActionListener(e -> {
                ...
                navigator.navigateTo(MenuNavigator.PLAYER_COUNT_SCREEN, this, gameConfig);
            });
        ...
        backButton.addActionListener(e -> navigator.navigateTo(MenuNavigator.MAIN_MENU_SCREEN, this, gameConfig));
