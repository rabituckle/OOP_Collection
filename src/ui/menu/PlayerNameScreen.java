...
public class PlayerNameScreen extends MenuScreen {
	...
	public void show() {
        ...
        if (numPlayers == 4) {
            ...
            nextButton.addActionListener(e -> {
                savePlayerNames(names);
                navigator.navigateTo(MenuNavigator.BOT_SELECTION_SCREEN, this, gameConfig);
            });
        ...
        backButton.addActionListener(e -> navigator.navigateTo(MenuNavigator.PLAYER_COUNT_SCREEN, this, gameConfig));
    ...
    private void validateName(JTextField name, int j, ArrayList<JTextField> names) {
