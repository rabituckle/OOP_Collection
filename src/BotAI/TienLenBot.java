...
public class TienLenBot {
	...
	public ArrayList<Card> beatSingle(ArrayList<Card> playerCard, ArrayList<Card> pre){
		ArrayList<Card> ans = new ArrayList<Card>();
	...
	public ArrayList<Card> beatDouble(ArrayList<Card> playerCard, ArrayList<Card> pre){
		for(int i = 0; i <= playerCard.size() - 2; i++) {
			ArrayList<Card> candidate = new ArrayList<>(playerCard.subList(i, i + 1));
	...
	public ArrayList<Card> beatTriple(ArrayList<Card> playerCard, ArrayList<Card> pre){
		ArrayList<Card> ans;
		for(int i = 0; i < playerCard.size() - 2; i++) {
			ans = new ArrayList<>(playerCard.subList(i, i + 2));
	...
	public ArrayList<Card> beatSequence(ArrayList<Card> playerCard, ArrayList<Card> pre){
		ArrayList<Card> ans = new ArrayList<Card>();
		int len = pre.size();
	...
	public ArrayList<Card> beatConsecutivePairs(ArrayList<Card> playerCard, ArrayList<Card> pre){
	...
	public ArrayList<Card> beatFourSeasons(ArrayList<Card> playerCard, ArrayList<Card> pre){
		ArrayList<Card> ans = new ArrayList<Card>();
